...
//    printf("");
  ...
  printf("\n============================================================================================================================================================\n");
        ...
        if (choice == 0) {
            printf("\n\t\t\t\t\t\t\033[1;32mThank you for using the Advanced Calculator! Goodbye!\033[0m\n\n");
            break;
        }
...
void displayHeader() {
    printf("\n\n\n\n\n============================================================================================================================================================\n");
    printf("\n\t\t\t\t\t\t\t\t\033[1;36m    🚀 ADVANCED CALCULATOR         \033[0m\n\n");
     printf("============================================================================================================================================================\n");
   printf("\t\t\t\t\t\t\t\033[1;34m\t   Your companion for Vectors, \n \t\t\t\t\t\t\t\t        And Probability\033[0m\n");
      printf("\033[1;36m============================================================================================================================================================\n");
...
void displayMenu() {
    ...
    printf("\t\t\t\t\t\t\033[1;32m3.   \033[0;1m Check Whether Vectors is Orthonormal\n \t\t\t\t\t\t\t   \033[0;90m(Determine a vector is orthonormal)\033[0m\n\n");
...
void HyperGeometric() {
    ...
    printf("\n\t\t\t\t\t\t\t   \033[1;34mThe probability of (X=%d) = %.5lf\033[0m\n", successSample, probability);
}
